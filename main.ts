...
function level2map () {
    main.setKind(SpriteKind.level2)
    ...
    scene.setBackgroundImage(img`
        ...
        `)
    game.showLongText("LEVEL2", DialogLayout.Bottom)
    game.showLongText("A TEST OF MEMORY", DialogLayout.Bottom)
    game.showLongText("Find the glowing door", DialogLayout.Bottom)
    scene.setBackgroundImage(img`
        ...
        7777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777
        `)
    tiles.placeOnRandomTile(main, assets.tile`myTile`)
}
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    Render.jumpWithHeightAndDuration(main, 15, 500)
})
function level4map () {
    main.setKind(SpriteKind.level4)
    snake.follow(main, 35)
    scene.setBackgroundImage(img`
        
    ...
    game.showLongText("Secret Tunnel", DialogLayout.Bottom)
    scene.setBackgroundImage(img`
        
    ...
    tiles.placeOnRandomTile(main, assets.tile`myTile3`)
    tiles.placeOnRandomTile(snake, sprites.dungeon.doorOpenNorth)
}
...
function level1map () {
    ...
    game.setDialogCursor(img`
        ...
        . . c c c c c c c c c f . . . . 
        `)
    game.showLongText("Welcome to Maze 2.", DialogLayout.Bottom)
    scene.setBackgroundImage(img`
        
        ...
        dddddddddd444ddddd3ddddddddddddd4ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd44dddddddddddddddddddddddddddddddddd4ddddddddd
        `)
    game.showLongText("Its great to see you back here :)", DialogLayout.Bottom)
    game.showLongText("Use arrow keys or wasd to look around              or move.", DialogLayout.Bottom)
    game.showLongText("Space bar to jump.", DialogLayout.Bottom)
    game.showLongText("Head to the Glowing Doors.", DialogLayout.Bottom)
    game.showLongText("And good luck.", DialogLayout.Bottom)
    main = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Player)
    main = Render.getRenderSpriteVariable()
    scene.setBackgroundImage(img`
        
...
function level3map () {
    snake = sprites.create(img`
        ...
        . . c c c c c c c c c f . . . . 
        `, SpriteKind.Enemy)
    snake.follow(main, 30)
    game.setGameOverPlayable(false, music.melodyPlayable(music.spooky), false)
    game.setGameOverEffect(true, effects.clouds)
    game.setGameOverPlayable(true, music.melodyPlayable(music.footstep), true)
    game.setGameOverMessage(true, "THANK YOU FOR PLAYING THE MAZE 2 TEASER")
    game.setGameOverMessage(false, "Better luck next time")
    main.setKind(SpriteKind.level3)
    scene.setBackgroundImage(img`
        
...
game.onUpdateInterval(2000, function () {
    if (main.kind() == SpriteKind.Player) {
        music.play(music.createSong(assets.song`level1mapsong0`), music.PlaybackMode.InBackground)
    } else if (main.kind() == SpriteKind.level2) {
        music.play(music.createSong(assets.song`level2`), music.PlaybackMode.InBackground)
    } else if (main.kind() == SpriteKind.level3) {
        music.play(music.createSong(assets.song`level3`), music.PlaybackMode.InBackground)
    } else {
        music.play(music.createSong(assets.song`level4song`), music.PlaybackMode.InBackground)
    }
})
